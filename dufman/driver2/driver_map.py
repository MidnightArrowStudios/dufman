...
from dufman.driver2.utils import get_channel_object
...
class DriverMap:
    ...
    def __init__(self:Self, figure_name:str) -> Self:
        ...
        # The asset this DriverMap is supposed to drive. May be used for the
        #   node_path section of the URL in the future.
        self._figure_name:str = figure_name

        # Master dictionary of all loaded drivers
        self._drivers:dict = {}

        # Cache the assets stored inside the drivers for easy access
